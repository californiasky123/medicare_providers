...
print("Should be 120 rows")
print(df.shape)

print("Below should have the new column added - this is the DF I just made.")
print(df.head())
...
print("Below should have the new column added - this is the DF head read back from the CSV")
print(df2.head())
