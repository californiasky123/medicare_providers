...
-- NOTE: TOOK OUT LOAD DATA INFILE BLOCK FOR REFERRAL REGION
...
INSERT referral_region(referral_region_desc) SELECT DISTINCT referral_region_desc FROM t_medicare_1;
